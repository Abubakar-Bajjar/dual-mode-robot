/*
 * ============================================================================
 *  MANUAL RC MODE — CAR / RECEIVER
 * ============================================================================
 *  Board:   Arduino Nano (car)
 *  Role:    Receives dual-joystick axis data from the remote over HC-05
 *           (configured as Slave), and drives a 4-motor (2x left, 2x right)
 *           chassis through an L298N H-bridge using tank-style mixing
 *           (throttle + steering).
 *
 *  Wiring:  docs/circuit-receiver-car.png
 * ============================================================================
 */
